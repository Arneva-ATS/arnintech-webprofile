    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="#!">
                <img class="logo-light" style="max-width: 9em;" src="{{ asset('template/img/logo/logo-ati.png') }}"
                    alt="logo">
                <img class="logo-dark" style="max-width: 9em;" src="{{ asset('template/img/logo/logo-ati.png') }}"
                    alt="logo">
            </a>
        ...
        <div class="offcanvas-contact-info">
            ...
            <ul class="contact-info list-style">
                <li>
                    ...
                    <a href="info@arneva.co.id">info@arnintech.co.id</a>
                </li>
                <li>
