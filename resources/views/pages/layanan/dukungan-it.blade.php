                ...
                <div class="courses-details">
                    ...
                    <div class="content">
                        <div class="content-pra">
                            ...
                            <p>Layanan Dukungan TI di Arnawa Teknologi Informasi bertujuan untuk memastikan bahwa sistem TI perusahaan Anda berfungsi optimal setiap saat. Kami menyediakan dukungan teknis yang handal dan responsif untuk membantu klien mengatasi masalah teknis dengan cepat dan efektif.</p>
                        ...
                        <div class="content-pra">
                            ...
                            <p>Sebuah perusahaan retail besar mengalami masalah dengan seringnya downtime sistem yang mengganggu operasional dan merugikan bisnis. Setelah bekerja sama dengan Arnawa Teknologi Informasi, kami melakukan penilaian menyeluruh terhadap sistem TI mereka dan mengidentifikasi area yang memerlukan perbaikan. Kami kemudian mengembangkan dan menerapkan rencana dukungan yang mencakup pemantauan sistem secara real-time, pemeliharaan rutin, dan pelatihan bagi staf internal. Hasilnya, uptime sistem perusahaan meningkat sebesar 99.9%, memungkinkan mereka untuk beroperasi tanpa gangguan dan meningkatkan efisiensi operasional secara keseluruhan. Dengan sistem yang stabil dan andal, perusahaan dapat fokus pada pertumbuhan bisnis dan meningkatkan kepuasan pelanggan.</p>
                        </div>
                    </div>

                    <p class="mt-3">Dengan layanan dukungan TI kami, Arnawa Teknologi Informasi siap membantu perusahaan Anda untuk memastikan bahwa sistem TI berfungsi dengan optimal setiap saat. Kami berkomitmen untuk memberikan solusi yang tidak hanya efektif tetapi juga dapat diandalkan dalam jangka panjang, memastikan bahwa perusahaan Anda dapat beroperasi dengan lancar dan siap menghadapi setiap tantangan teknis yang mungkin muncul.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="course-widget-area">
                            <div class="image">
                                <img src="{{ asset('template/img/layanan/5.png') }}" alt="image">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="col-12 mb-3">
                        ...
                        <div class="academics-left" style="margin-left:20px;">
                            <div class="ac-category">
                                <ul>
                                    ...
                                    <li><a class="mb-2 active" href="{{ route('layanan.dukungan-it') }}">Dukungan TI</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
